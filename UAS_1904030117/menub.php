...
$databar = query("SELECT * FROM data_barang");

if (isset($_GET['cari'])) {
  $databar = cari($_GET['keyword']);
}
  ...
  <div class="container">
    <div class="mt-5">
      ...
      <table class="table table-striped">
        ...
        <tbody>
          <?php $id = 1; ?>
          <?php foreach ($databar as $dtb) : ?>
            <tr class="text-center">
              <th scope="row"><?php echo $id; ?></th>
              <td><?php echo $dtb['nama']; ?></td>
              <td><img src="assets/img/<?php echo $dtb['foto_barang']; ?>" width="75px"></td>
              <td><a href="detail.php?id=<?= $dtb['id']; ?>" class="btn btn-warning" role="button">Detail</a></td>
            </tr>
            <?php $id++ ?>
          <?php endforeach ?>
        </tbody>
