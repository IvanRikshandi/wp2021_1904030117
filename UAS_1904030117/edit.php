  ...
  <div class="container">
    <div class="mt-5">
      ...
      <form method="POST" action="">
        ...
        <input type="hidden" class="form-control" value="<?= $databar['id'] ?>" name="id">

        <div class="mb-3">
          <label for="nama" class="form-label">Nama Barang</label>
          <input type="text" class="form-control" id="nama" name="nama" value="<?= $databar['nama'] ?>" placeholder="Nama Barang" required autocomplete="off">
        </div>

        <div class="mb-3">
          <label for="stock" class="form-label">Input Stock</label>
          <input type="text" class="form-control" id="stock" name="stock" value="<?= $databar['stock'] ?>" placeholder="Stock Barang" required autocomplete="off">
        </div>

        <div class="mb-3">
          <label for="foto_barang" class="form-label">Foto Barang</label>
          <input type="text" class="form-control" id="foto_barang" name="foto_barang" value="<?= $databar['foto_barang'] ?>" placeholder="Foto Barang" required autocomplete="off">
        </div>

        <div class="mb-3">
          <label for="harga_eceran" class="form-label">Harga Eceran</label>
          <input type="text" class="form-control" id="harga_eceran" name="harga_eceran" value="<?= $databar['harga_eceran'] ?>" placeholder="Harga Eceran" required autocomplete="off">
        </div>

        <div class="mb-3">
          <label for="harga_grosir" class="form-label">Harga Grosir</label>
          <input type="text" class="form-control" id="harga_grosir" name="harga_grosir" value="<?= $databar['harga_grosir'] ?>" placeholder="Harga Grosir" required autocomplete="off">
        </div>
