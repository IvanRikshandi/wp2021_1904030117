...
<body>
  ...
  <div class="row mt-4">
    ...
    <div class="col-md-10 p-5 pt-5">
      <!-- konten -->
      <h3><i class="fas fa-user-edit"></i> Input Data Calon Mahasiswa</h3>
      <hr>
      ...
      <form method="POST" action="">
        ...
        <div class="mb-3">
          ...
          <textarea class="form-control" id="alamat" name="alamat" rows="4" placeholder="Alamat Lengkap" required autocomplete="off"></textarea>
        </div>

        <div class="mb-3">
          <label for="jenis_kelamin" class="form-label">Jenis Kelamin</label>
          <input type="text" class="form-control" id="jenis_kelamin" name="jenis_kelamin" placeholder="Jenis Kelamin" required autocomplete="off">
        </div>

        <div class="mb-3">
          <label for="agama" class="form-label">Agama</label>
          <input type="text" class="form-control" id="agama" name="agama" placeholder="Agama" required autocomplete="off">
        </div>

        <div class="mb-3">
          <label for="sekolah_asal" class="form-label">Sekolah Asal</label>
          <input type="text" class="form-control" id="sekolah_asal" name="sekolah_asal" placeholder="Sekolah Asal" required autocomplete="off">
        </div>

        <div class="mb-3">
          <label for="foto_maba" class="form-label">Foto</label>
          <input type="text" class="form-control" id="foto_maba" name="foto_maba" placeholder="Input Foto" required autocomplete="off">
        </div>
