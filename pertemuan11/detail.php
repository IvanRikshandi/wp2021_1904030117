  ...
  <div class="row mt-4">
    ...
    <div class="col-md-10 p-5 pt-5">
      ...
      <ul class="list-group">
        ...
        <li class="list-group-item"><img src="image/<?= $camaba['foto_maba']; ?>" width="200px"></li>
        <li class="list-group-item">
          <a href="edit.php?id=<?= $camaba['id']; ?>" class="btn btn-warning" role="button">Edit</a> |
          <a href="hapus.php?id=<?= $camaba['id']; ?>" onclick="return confirm('Yakin menghapus data ini ?');" class="btn btn-danger" role="button">Hapus</a> |
